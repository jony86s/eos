...
namespace eosio { namespace chain { namespace backing_store {
   ...
   struct secondary_helper<uint64_t> {
      ...
      int32_t overhead() { return config::billable_size_v<index64_object>;}
   };
   ...
   struct secondary_helper<eosio::chain::uint128_t> {
      ...
      int32_t overhead() { return config::billable_size_v<index128_object>;}
   };
   ...
   struct secondary_helper<eosio::chain::key256_t> {
      ...
      int32_t overhead() { return config::billable_size_v<index256_object>;}
   };
   ...
   struct secondary_helper<float64_t> {
      ...
      int32_t overhead() { return config::billable_size_v<index_double_object>;}
   };
   ...
   struct secondary_helper<float128_t> {
      ...
      int32_t overhead() { return config::billable_size_v<index_long_double_object>;}
   };
